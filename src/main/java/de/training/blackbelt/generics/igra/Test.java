...
public class Test {
    ...
    public static void main(String[] args) {
        ...
        Team<Student> studentTeam = new Team("Vorwärts");
        Team<Employee> employeeTeam = new Team("Maschinen");
        ...
        Team<Schoolar> schoolarTeam2 = new Team("PowerFul");
        Schoolar schoolar3 = new Schoolar("Sergey",12);
        Schoolar schoolar4 = new Schoolar("Oleg",14);
